...
export interface Dictionary {
  ...
  biometricDevice: {
    ...
    deleteFingerprintConfirm: string;
    startEnrollTitle: string;
    startEnrollConfirm: string;
    startEnrollNote: string;
    enrollStarted: string;
    ...
    clearLogDesc: string;
    clearLogConfirmLabel: string;
    clearLogConfirmWord: string;
    clearLogDone: string;
    ...
    syncDescConnected: string;
    syncDescReconnecting: string;
    syncDescPaused: string;
    syncNoNew: string;
