...
export function toEmployee(e: PEmployee): Employee {
  return {
    ...
    payTypeId: e.payTypeId ?? undefined,
    workScheduleId: e.workScheduleId ?? undefined,
    customWorkStart: e.customWorkStart ?? undefined,
    customWorkEnd: e.customWorkEnd ?? undefined,
    customOvertimeStart: e.customOvertimeStart ?? undefined,
...
export function toOvertime(o: POvertime): Overtime {
  return {
    ...
    kind: o.kind,
    multiplier: o.multiplier ?? undefined,
    autoGenerated: o.autoGenerated,
    originalHours: o.originalHours ?? undefined,
    originalAmount: o.originalAmount ?? undefined,
    editedBy: o.editedBy ?? undefined,
  };
}
