...
import { startAttendanceAutoSync } from "@/lib/attendance-sync";
...
// an actual running server, so the interval isn't started (and immediately
// discarded) a dozen times during every build.
