...
- [ ] إضافة Vitest
- [ ] اختبارات وحدة لـ `attendance-engine` (تأخير، سماح، انصراف مبكر، بصمة ناقصة، وردية ليلية)
- [ ] اختبارات وحدة لـ `payroll-engine` (المثال الرسمي §30: صافي 11,900)
- [ ] اختبار تكامل لسيناريو القبول §55 كامل (عبر استدعاء الـ server actions)
- [ ] تشغيل يدوي موجّه للسيناريو في المتصفح + لقطات
- [ ] توثيق أي bug في قسم "الثغرات الصغيرة" أعلاه ونصلحه
